                ...
                <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        @foreach ($apps as $app)
                            <div class="portfolio-wrap">
                                <img src="{{ asset("uploads/apps/$app->mainImage") }}" class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>{{ $app->name }}</h4>
                                    <p>{{ $app->description }}</p>
                                    <div class="portfolio-links">
                                        <a href="{{ asset("uploads/apps/$app->mainImage") }}"
                                            data-gallery="portfolioGallery" class="portfokio-lightbox"
                                            title="{{ $app->name }}"><i class="bi bi-plus"></i></a>
                                        <a href="{{ route('products.show', $app->id) }}" title="More Details"><i
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        @foreach ($websites as $website)
                            <div class="portfolio-wrap">
                                <img src="{{ asset("uploads/websites/$website->mainImage") }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>{{ $website->name }}</h4>
                                    <p>{{ $website->description }}</p>
                                    <div class="portfolio-links">
                                        <a href="{{ asset("uploads/websites/$website->mainImage") }}"
                                            data-gallery="portfolioGallery" class="portfokio-lightbox"
                                            title="{{ $website->name }}"><i class="bi bi-plus"></i></a>
                                        <a href="{{ route('products.show', $website->id) }}" title="More Details"><i
                                                class="bi bi-link"></i></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        @foreach ($designs as $design)
                            <div class="portfolio-wrap">
                                <img src="{{ asset("uploads/designs/$design->mainImage") }}" class="img-fluid"
                                    alt="">
                                <div class="portfolio-info">
                                    <h4>{{ $design->name }}</h4>
                                    <p>{{ $design->description }}</p>
                                    <div class="portfolio-links">
                                        <a href="{{ asset("uploads/designs/$design->mainImage") }}"
                                            data-gallery="portfolioGallery" class="portfokio-lightbox"
                                            title="{{ $design->name }}"><i class="bi bi-plus"></i></a>
                                        <a href="{{ route('products.show', $design->id) }}" title="More Details"><i
                                                class="bi bi-link"></i></a>
                                    </div>
                                </div>
                            </div>
